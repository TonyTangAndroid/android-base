...
public class SearchMovieUseCaseTest {
    ...
    @Mock
    private NoteRepository mockNoteEntityListRepository;
    ...
    public void setup() throws IOException {
        ...
        SearchMovieUseCase searchNoteEntityUseCase = new SearchMovieUseCase(mockThreadExecutor,
    ...
    private List<NoteEntity> list(String keywordDarkNight) throws IOException {
        String json = TestUtils.json(keywordDarkNight + ".json", this);
        return new Gson().fromJson(json, new TypeToken<List<NoteEntity>>() {
        }.getType());
    }
