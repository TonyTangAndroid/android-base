...
public abstract class NoteEntity {
    ...
    @Nullable
    @SerializedName("ACL")
    public abstract com.tony.tang.note.domain.entity.PermissionItemList ACL();
    ...
    public abstract static class Builder {
        ...
        public abstract Builder ACL(com.tony.tang.note.domain.entity.PermissionItemList ACL);
